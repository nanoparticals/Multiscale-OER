...
calc=VaspFCP(xc='PBE', #functional
      ...
      U=1.471,                                          #electrochemical potential vs. SHE
      NELECT =1015,                                 #initial guass of number of electrons
      NELECT0=1015,                                    #number of electrons at the potential of zero charge
